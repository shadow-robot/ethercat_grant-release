...
The packages in the `ethercat_grant` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic --track noetic ethercat_grant` on `Sun, 14 Mar 2021 21:22:47 -0000`
...
The packages in the `ethercat_grant` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic --track noetic ethercat_grant` on `Sun, 14 Mar 2021 21:16:57 -0000`
